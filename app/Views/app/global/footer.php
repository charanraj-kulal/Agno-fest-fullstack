    ...
    <script src="<?= base_url('assets/web/vendors/counterup/counterup.min.js') ?>"></script>
    <script src="<?= base_url('assets/web/vendors/owlcarousel/owl.carousel.min.js') ?>"></script>
    <script src="<?= base_url('assets/web/vendors/tempusdominus/js/moment.min.js') ?>"></script>
    ...
    <script src="<?= base_url('assets/web/js/jquery-3.6.0.js') ?>"></script>
