...
<body>
    ...
    <div class=" container-fluid bg-dark p-0 main-contents">
        ...
        <!-- Spinner End -->
         <!-- Loading Video Start -->
            <div id="loading-screen" class="show position-fixed w-100 vh-120 top-0 start-0 d-flex align-items-center justify-content-center" style="background-color: #000000; z-index: 9999;">
