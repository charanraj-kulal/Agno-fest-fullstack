    ...
    function renderEventTable(events) {
        ...
        $.each(events, function (index, event) {
            var newRow =
                ...
                "<td>" + event.coding_mem_1 + "</td>" +
                "<td>" + event.coding_mem_contact_1 + "</td>" +
                "<td>" + event.coding_mem_2 + "</td>" +
                "<td>" + event.coding_mem_contact_2 + "</td>" +
                "<td>" + event.quiz_mem_1 + "</td>" +
                "<td>" + event.quiz_mem_contact_1 + "</td>" +
                "<td>" + event.quiz_mem_2 + "</td>" +
                "<td>" + event.quiz_mem_contact_2 + "</td>" +
                "<td>" + event.web_mem_1 + "</td>" +
                "<td>" + event.web_mem_contact_1 + "</td>" +
                "<td>" + event.web_mem_2 + "</td>" +
                "<td>" + event.web_mem_contact_2 + "</td>" +
                "<td>" + event.game_mem_1 + "</td>" +
                "<td>" + event.game_mem_contact_1 + "</td>" +
                "<td>" + event.game_mem_2 + "</td>" +
                "<td>" + event.game_mem_contact_2 + "</td>" +
                "<td>" + event.game_mem_3 + "</td>" +
                "<td>" + event.game_mem_contact_3 + "</td>" +
                "<td>" + event.game_mem_4 + "</td>" +
                "<td>" + event.game_mem_contact_4 + "</td>" +
                "<td>" + event.itmanager_mem_1 + "</td>" +
                "<td>" + event.itmanager_mem_contact_1 + "</td>" +
                "<td>" + event.photo_mem_1 + "</td>" +
                "<td>" + event.photo_mem_contact_1 + "</td>" +
                "<td>" + event.video_mem_1 + "</td>" +
                "<td>" + event.video_mem_contact_1 + "</td>" +
                "<td>" + event.video_mem_2 + "</td>" +
                "<td>" + event.video_mem_contact_2 + "</td>" +
                "<td>" + event.thunt_mem_1 + "</td>" +
                "<td>" + event.thunt_mem_contact_1 + "</td>" +
                "<td>" + event.thunt_mem_2 + "</td>" +
                "<td>" + event.thunt_mem_contact_2 + "</td>" +
                "</tr>";
...
$("#all-event-report-export-pdf-btn").click(function () {
    ...
    var transposedData = data[0].map((_, colIndex) => data.map(row => row[colIndex]));
