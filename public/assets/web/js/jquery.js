!(function (e, t) {
  ...
  var d = (function (n) {
    ...
    try {
      O.apply((q = F.call(x.childNodes)), x.childNodes),
              ...
              ((o = (function e(t) {
                for (
                  ...
                  if ((n = b.relative[t[u].type])) f = [de(he(f), n)];
                    ...
                    if (
                      (n = b.filter[t[u].type].apply(null, t[u].matches))[E]
                    ) {
  ...
  (C.filter = function (e, t, n) {
    ...
    C.fn.extend({
      ...
      is: function (e) {
        return !!E(this, "string" == typeof e && x.test(e) ? C(e) : e || [], !1)
          .length;
      },
    });
  var N = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
        ...
        C.fn[r] = function (e, t) {
          ...
          return (
            (t = "Until" !== r.slice(-5) ? e : t) &&
              ...
              (n = C.filter(t, n)),
            1 < this.length &&
              (D[r] || C.uniqueSort(n), j.test(r) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
  ...
  var q,
    L = /\S+/g;
  function H() {
    T.removeEventListener("DOMContentLoaded", H),
      w.removeEventListener("load", H),
      C.ready();
  }
        ...
        if (void 0 !== o) {
          if (void 0 === t) this.register(e);
            ...
            n = (r = C.isArray(t)
              ...
              : ((i = C.camelCase(t)),
                t in o ? [t, i] : (r = i) in o ? [r] : r.match(L) || []))
              .length;
            for (; n--; ) delete o[r[n]];
          }
  ...
  C.extend({
        ...
        if (
          ...
          for (t = s.length; t--; )
            s[t] &&
              ...
              ((n = C.camelCase(n.slice(5))), $(o, n, i[n]));
    ...
    C.extend({
      queue: function (e, t, n) {
        var r;
        return e
          ? ((r = R.get(e, (t = (t || "fx") + "queue"))),
            n &&
              (!r || C.isArray(n)
                ? (r = R.access(e, t, C.makeArray(n)))
                : r.push(n)),
            r || [])
          : void 0;
      },
  ...
  (n = T.createDocumentFragment().appendChild(T.createElement("div"))),
    (d = T.createElement("input")).setAttribute("type", "radio"),
  ...
  function ge(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        R.hasData(e) &&
        ((o = R.access(e)), (s = R.set(t, o)), (a = o.events))
      )
  ...
  function ve(n, r, i, o) {
    ...
    if (
      f &&
      ((t = (e = Z(r, n[0].ownerDocument, !1, n, o)).firstChild),
      1 === e.childNodes.length && (e = t),
      t || o)
    ) {
      for (a = (s = C.map(Q(e, "script"), de)).length; c < f; c++)
        (u = e),
          c !== p &&
            ((u = C.clone(u, !0, !0)), a && C.merge(s, Q(u, "script"))),
          i.call(n[c], u, c);
      if (a)
        for (l = s[s.length - 1].ownerDocument, C.map(s, he), c = 0; c < a; c++)
          (u = s[c]),
            Y.test(u.type || "") &&
              ...
              (u.src
                ...
                : C.globalEval(u.textContent.replace(fe, "")));
    }
    return n;
  }
  function me(e, t, n) {
    for (var r, i = t ? C.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || C.cleanData(Q(r)),
        r.parentNode &&
          (n && C.contains(r.ownerDocument, r) && J(Q(r, "script")),
  ...
  C.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (t)
        if (n)
          for (o = o || Q(e), s = s || Q(c), r = 0, i = o.length; r < i; r++)
            ge(o[r], s[r]);
        else ge(e, c);
    ...
    C.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (C.cleanData(Q(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
          ...
          function (e) {
            ...
            if (
              ...
              try {
                for (; n < r; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (C.cleanData(Q(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return ve(
          ...
          function (e) {
            ...
            C.inArray(this, n) < 0 &&
              (C.cleanData(Q(this)), t && t.replaceChild(e, this));
          },
          n
        );
      },
  ...
  (je = T.createElement("div")),
    (De = T.createElement("div")).style &&
      ((De.style.backgroundClip = "content-box"),
      (De.cloneNode(!0).style.backgroundClip = ""),
      (v.clearCloneStyle = "content-box" === De.style.backgroundClip),
      (je.style.cssText =
      ...
      C.extend(v, {
        ...
        reliableMarginRight: function () {
          var e,
            t = De.appendChild(T.createElement("div"));
          return (
            (t.style.cssText = De.style.cssText =
  ...
  function _e(e, t, n, r, i) {
    for (
      ...
      "margin" === n && (s += C.css(e, n + X[o], !0, i)),
        r
          ? ("content" === n && (s -= C.css(e, "padding" + X[o], !0, i)),
            "margin" !== n && (s -= C.css(e, "border" + X[o] + "Width", !0, i)))
          : ((s += C.css(e, "padding" + X[o], !0, i)),
            "padding" !== n &&
              (s += C.css(e, "border" + X[o] + "Width", !0, i)));
    return s;
  }
  function Xe(e, t, n) {
    var r = !0,
    ...
    if (i <= 0 || null == i) {
      if (
        (((i = Oe(e, t, o)) < 0 || null == i) && (i = e.style[t]), qe.test(i))
      )
        return i;
      ...
      (r = e[s]).style &&
        ...
        t
          ? (o[s] || "none" !== n || (r.style.display = ""),
            "" === r.style.display &&
              B(r) &&
              (o[s] = R.access(r, "olddisplay", we(r.nodeName))))
          : ((i = B(r)),
            ("none" === n && i) ||
              R.set(r, "olddisplay", i ? n : C.css(r, "display"))));
    for (s = 0; s < a; s++)
      (r = e[s]).style &&
  ...
  C.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          u = e.style;
        return (
          (t = C.cssProps[a] || (C.cssProps[a] = $e(a) || a)),
    ...
    css: function (e, t, n, r) {
      var i,
        o = C.camelCase(t);
      return (
        (t = C.cssProps[o] || (C.cssProps[o] = $e(o) || o)),
        "normal" ===
          (i =
            void 0 ===
            (i =
      ...
      C.cssHooks[o] = {
        ...
        set: function (e, t, n) {
          var r,
            ...
            i =
              n &&
              _e(e, o, n, "border-box" === C.css(e, "boxSizing", !1, i), i);
          return (
            i &&
              (r = _.exec(t)) &&
              "px" !== (r[3] || "px") &&
    ...
    (C.cssHooks.marginRight = Fe(v.reliableMarginRight, function (e, t) {
      return t
        ? Ce(e, { display: "inline-block" }, Oe, [e, "marginRight"])
        : void 0;
    })),
  ...
  function et(i, e, t) {
    var n,
      ...
      l = a.promise({
        ...
        stop: function (e) {
          ...
          return (
            e
              ? (a.notifyWith(i, [l, 1, 0]), a.resolveWith(i, [l, e]))
              : a.rejectWith(i, [l, e]),
            this
          );
        },
    ...
    for (
      ...
      if ((n = et.prefilters[r].call(l, i, c, l.opts)))
        return (
          C.isFunction(n.stop) &&
            (C._queueHooks(l.elem, l.opts.queue).stop = C.proxy(n.stop, n)),
          n
        );
    return (
      C.map(c, Ze, l),
      C.isFunction(l.opts.start) && l.opts.start.call(i, l),
  ...
  (C.Animation = C.extend(et, {
    ...
    tweener: function (e, t) {
      for (
        var n,
          r = 0,
          i = (e = C.isFunction(e) ? ((t = e), ["*"]) : e.match(L)).length;
        r < i;
        r++
      )
        (n = e[r]),
    ...
    prefilters: [
      function (t, e, n) {
        ...
        1 === t.nodeType &&
          ...
          "inline" ===
            ("none" === (l = C.css(t, "display"))
              ? R.get(t, "olddisplay") || we(t.nodeName)
              : l) &&
            "none" === C.css(t, "float") &&
        ...
        if (C.isEmptyObject(f))
          "inline" === ("none" === l ? we(t.nodeName) : l) && (p.display = l);
        else
          for (r in (h
    ...
    (s = n.appendChild(T.createElement("option"))),
    (d.type = "checkbox"),
    (v.checkOn = "" !== d.value),
    (v.optSelected = s.selected),
    (n.disabled = !0),
    (v.optDisabled = !s.disabled),
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return void 0 === e.getAttribute
            ...
            : ((1 === o && C.isXMLDoc(e)) ||
                ((t = t.toLowerCase()),
                (i =
                  C.attrHooks[t] || (C.expr.match.bool.test(t) ? tt : void 0))),
              void 0 !== n
                ? null === n
    ...
    toggleClass: function (i, t) {
      ...
      return "boolean" == typeof t && "string" == o
        ...
        : this.each(function () {
            var e, t, n, r;
            if ("string" == o)
              for (t = 0, n = C(this), r = i.match(L) || []; (e = r[t++]); )
    ...
    trigger: function (e, t, n, r) {
      ...
      if (
        ...
        if (!r && !l.noBubble && !C.isWindow(n)) {
          for (
            s = l.delegateType || f, lt.test(s + f) || (d = d.parentNode);
            d;
            d = d.parentNode
          )
            c.push(d), (o = d);
        ...
        for (i = 0; (d = c[i++]) && !e.isPropagationStopped(); )
          (e.type = 1 < i ? s : l.bindType || f),
            (u = (R.get(d, "events") || {})[e.type] && R.get(d, "handle")) &&
              u.apply(d, t),
            (u = a && d[a]) &&
              u.apply &&
              F(d) &&
  ...
  (wt.href = ct.href),
    C.extend({
      ...
      ajax: function (e, t) {
        ...
        if (
          ((v.promise(b).complete = m.add),
          (b.success = b.done),
          (b.error = b.fail),
          (d.url = ((e || d.url || ct.href) + "")
            .replace(dt, "")
            .replace(mt, ct.protocol + "//")),
          (d.type = t.method || t.type || d.method || d.type),
          (d.dataTypes = C.trim(d.dataType || "*")
            .toLowerCase()
            .match(L) || [""]),
          null == d.crossDomain)
        ) {
        ...
        d.hasContent ||
          (d.data &&
            ((l = d.url += (pt.test(l) ? "&" : "?") + d.data), delete d.data),
          !1 === d.cache &&
            (d.url = ht.test(l)
              ? l.replace(ht, "$1_=" + ft++)
              : l + (pt.test(l) ? "&" : "?") + "_=" + ft++)),
        ...
        for (r in ((s = "abort"), { success: 1, error: 1, complete: 1 }))
          b[r](d[r]);
        if ((u = Ct(xt, d, t, b))) {
          if (((b.readyState = 1), p && g.trigger("ajaxSend", [b, d]), 2 === x))
            return b;
          d.async &&
            0 < d.timeout &&
        ...
        function a(e, t, n, r) {
          ...
          2 !== x &&
            ...
            (b.status = e),
            (b.statusText = (t || a) + ""),
            r ? v.resolveWith(h, [i, a, b]) : v.rejectWith(h, [b, a, o]),
            b.statusCode(y),
            (y = void 0),
  ...
  (C.fn.load = function (e, t, n) {
    ...
    C.each(["top", "left"], function (e, n) {
      C.cssHooks[n] = Fe(v.pixelPosition, function (e, t) {
        return t
          ? ((t = Oe(e, n)), qe.test(t) ? C(e).position()[n] + "px" : t)
          : void 0;
      });
    }),
