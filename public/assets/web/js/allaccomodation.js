$(document).ready(function () {
  ...
  $.ajax({
    url: "/dashboard/getAllAccommodationData",
    method: "GET",
    success: function (response) {
      ...
      if (response.hasOwnProperty("accommodations")) {
        ...
        console.error(
          "Response does not contain 'accommodations' property:",
          response
        );
        // Handle error
      }
  ...
  function renderAccommodationTable(accommodations) {
    ...
    $.each(accommodations, function (index, accommodation) {
      var newRow =
        "<tr>" +
        "<td>" +
        accommodation.team_name +
        "</td>" +
        "<td>" +
        accommodation.numofboys +
        "</td>" +
        "<td>" +
  ...
  $("#accommodationSearchInput").on("input", function () {
    ...
    var filteredAccommodations = originalAccommodations.filter(function (
      accommodation
    ) {
